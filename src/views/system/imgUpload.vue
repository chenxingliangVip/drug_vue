...
<style scoped lang="scss">
    .imgupload{
        .imgItemParent{
            ...
            .name{
                padding: 5px 0;font-size: 12px;color: #333333;
        ...
        .imgItem{
            ...
            width: 120px;height: 120px;box-sizing: border-box;
            position: relative;display: flex;align-items: center;
            justify-content: center;background-color: #fbfdff;
            &.active{
                border: 1px solid #409eff;background-color: #eff6ff;
            }
            .el-icon-plus{
                font-size: 30px;color: #cccccc;
            }
            .el-icon-delete{
                font-size: 12px;position: absolute;right: 0;top: 0;padding: 5px;
                cursor: pointer;z-index: 2;background: rgba(0,0,0,0.6);color: #ffffff;
            }
            input{
