      ...
      getList() {
        ...
        self.$http({
          ...
          if (resp.success) {
            ...
            self.imgArr1.push({url:""});
            self.imgArr2.push({url:""});
          }
        });
      },
            ...
            let param = {id:data.id,fileCheck:"1",fileType:this.logoType};
            params.push(param);
          }
          ...
          for(let data of checkedVal2){
            let param = {id:data.id,fileCheck:"1",fileType:this.screenType};
            params.push(param);
          }
          this.updateImagesStatus(params);
