  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        levelObj: {itemName: "",itemCode:"type"},
        tableData: [],
        tableHeader: [],
        tableLoading: true,
        ...
        self.$http({
          ...
          if (resp.success) {
            ...
            self.tableHeader = [{"columnName": "createTimeFt", "coloumNameCn": "日期", "width": "150px"},
              {"columnName": "itemName", "coloumNameCn": "规格名称"}];
        ...
        this.$refs["dataForm"].validate((valid) => {
          if (valid) {
            ...
            self.$http({
              ...
              if (resp.success) {
                self.levelObj = {itemName: "", serialNo: "",itemCode:"type"};
                self.getList();
              }
            });
          } else {
    ...
    watch: {
      paramData(val) {
        ...
        self.levelObj = {itemName: "",itemCode:"type"};
        self.getList();
      }
    }
  }
