  ...
  <el-dialog title="参数设定-样品规模"
    ...
    <div class="el-div-container">
      <el-form ref="dataForm" :model="levelObj" :rules="rules" :inline="true"  class="demo-form-inline">
        ...
        <el-form-item label="规模名称" prop="itemName">
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        levelObj: {itemName: "",itemCode:"scope"},
        tableData: [],
        tableHeader: [],
        tableLoading: true,
        ...
        self.$http({
          ...
          if (resp.success) {
            ...
            self.tableHeader = [{"columnName": "createTimeFt", "coloumNameCn": "日期", "width": "150px"},
              {"columnName": "itemName", "coloumNameCn": "规模名称"}];
        ...
        this.$refs["dataForm"].validate((valid) => {
          if (valid) {
            ...
            self.$http({
              ...
              if (resp.success) {
                self.levelObj = {itemName: "",itemCode:"scope"};
                self.getList();
              }
            });
          } else {
