  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        levelObj: {itemName: "", serialNo: "",itemCode:"grade"},
        tableData: [],
        tableHeader: [],
        tableLoading: true,
        ...
        self.$http({
          ...
          if (resp.success) {
            ...
            self.tableHeader = [{"columnName": "createTimeFt", "coloumNameCn": "日期", "width": "150px"},
              {"columnName": "itemName", "coloumNameCn": "等级名称"},
              {"columnName": "serialNo", "coloumNameCn": "等级代码"}];
        ...
        this.$refs["dataForm"].validate((valid) => {
          if (valid) {
            ...
            self.$http({
              ...
              if (resp.success) {
                self.levelObj = {itemName: "", serialNo: "",itemCode:"grade"};
                self.getList();
              }
            });
          } else {
