  ...
  <el-dialog title="参数设定-送样地点"
    ...
    <div class="el-div-container">
      <el-form ref="dataForm" :model="levelObj" :rules="rules" :inline="true"  class="demo-form-inline">
        ...
        <el-form-item label="地点名称" prop="itemName">
  ...
  export default {
        ...
        self.$http({
          ...
          if (resp.success) {
            ...
            self.tableHeader = [{"columnName": "createTimeFt", "coloumNameCn": "日期", "width": "150px"},
              {"columnName": "itemName", "coloumNameCn": "地点名称"}];
        ...
        this.$refs["dataForm"].validate((valid) => {
          if (valid) {
            ...
            self.$http({
              ...
              if (resp.success) {
                self.levelObj = {itemName: "", serialNo: "",itemCode:"location"};
                self.getList();
              }
            });
          } else {
    ...
    watch: {
      paramData(val) {
        ...
        self.levelObj = {itemName: "",itemCode:"location"};
        self.getList();
      }
    }
  }
