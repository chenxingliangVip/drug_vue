<template>
  <el-dialog :title="type=='add'?'新增·检验规则':'修改·检验规则'" width="50%" append-to-body
             :close-on-click-modal="false"
             :visible.sync="dialogAddVisible">
    <el-form ref="dataForm" size="mini" label-width="80px">
      <div class="dialog-title"><span>{{titleTxt}}检验规则</span></div>
      <el-divider></el-divider>
      <el-row>
        <el-col :span="24">
          <div class="el-dialog-item"><label>代码等级：</label>
      ...
      <div class="el-dialog-group dialogcolumn"><label>检测部门：</label>
        <el-checkbox-group v-model="inspectData.deptIds"
