...
<template>
    <div class="calendar">
        <div class="calendar-tools">
            ...
            <div class="choose-all"  @click.stop="chooseAll" v-if="this.multi">全选</div>
            <div class="choose-reverse" @click.stop="chooseReverse" v-if="this.multi">反选</div>
...
export default {
    props: {
        ...
        weeks: {
            type: Array,
            default:function(){
                return window.navigator.language.toLowerCase() == "zh-cn"?['日', '一', '二', '三', '四', '五', '六']:['周一', '周二', '周三', '周四', '周五', '周六', '周末']
            }
        },
        // 自定义月份
        months:{
